...
{
    /// <summary>
    /// ViewModel for a single notification toast popup
    /// </summary>
    public partial class NotificationToastViewModel : ObservableObject
    {
        private readonly DispatcherTimer _dismissTimer;
        private Action<NotificationToastViewModel>? _onDismiss;
        private Action<NotificationToastViewModel>? _onClick;
        ...
        public NotificationToastViewModel(Notification notification, Action<NotificationToastViewModel> onDismiss, Action<NotificationToastViewModel> onClick)
        {
        ...
        public string PriorityColor
        {
            get
            {
                ...
                {
                    NotificationPriority.Low => "#1976D2",      // Blue
                    NotificationPriority.Medium => "#F57C00",   // Orange
                    NotificationPriority.High => "#D32F2F",     // Red
                    NotificationPriority.Critical => "#C62828", // Dark Red
                    _ => "#1976D2"
                };
            }
        }
        ...
        public string TypeIcon
        {
            get
            {
                return Notification.Type switch
                {
                    ...
                    NotificationType.System => "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z",
                    _ => "M12 2A10 10 0 1 0 22 12A10 10 0 0 0 12 2Z"
                };
            }
        }
